...
$mensaje = "La Valoración ha sido modificada con éxito.";

//obtengo los valores POST
// -------------------------------------------------------------------
$id = $_POST['idvaloracion'];
$nombre = mb_ucfirst(mb_strtolower($_POST['nombre'],"UTF-8"));
$descripcion = mb_ucfirst(mb_strtolower($_POST['descripcion']));
...
try{
    ...
    $respuesta = $valoracion->editarValoracion($vReclamo);
    
}catch(Exception $ex){
    $respuesta = 0;
    //$mensaje = "No se ha realizado la modificación de la valoración.";
...
<html>
    ...
    <body>
        ...
        <section id="main-content">
            <article>
                <div class="content">
                    <h3>Modificaci&oacute;n de Valoraci&oacute;n de tipo Reclamo</h3>
                    <?php if($respuesta){ ?>

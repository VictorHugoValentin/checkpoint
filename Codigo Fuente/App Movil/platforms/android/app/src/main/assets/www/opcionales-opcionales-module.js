...
var OpcionalesPage = /** @class */ (function () {
    function OpcionalesPage(camara, mysql, formBuilder, router, route, webview) {
        ...
        this.todo = this.formBuilder.group({
            descripcion: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(200)],
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(/^[a-zA-Z0-9\._-]+@[a-zA-Z0-9-]{2,}[.]+(?:[A-Z]{2}|com|org|net|gov|ar|biz|info|mobi|name|aero|jobs|museum)\b/)
                ])],
        });
        this.email = null;
